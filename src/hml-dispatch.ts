...
.landing .hero-copy p::before{content:"";display:block;width:min(520px,100%);aspect-ratio:3/1;background:url('/brand/logo-primary.webp') left center/contain no-repeat;margin:2px 0 22px}
