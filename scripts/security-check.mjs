...
if (hml?.main !== 'src/hml-commerce.ts') fail('HML must use the commercial lifecycle isolated entrypoint');
...
requireText(hmlCommerce, '/api/signup/verify', 'HML commerce gateway');
requireText(hmlCommerce, '/api/billing/pix', 'HML commerce gateway');
requireText(hmlCommerce, '/api/webhooks/mercadopago', 'HML commerce gateway');
requireText(hmlCommerce, 'X-Idempotency-Key', 'HML commerce gateway');
requireText(hmlCommerce, 'x-signature', 'HML commerce gateway');
requireText(hmlCommerce, 'RESEND_API_KEY', 'HML commerce gateway');
requireText(hmlCommerce, 'MERCADOPAGO_ACCESS_TOKEN', 'HML commerce gateway');
requireText(hmlCommerce, 'MERCADOPAGO_WEBHOOK_SECRET', 'HML commerce gateway');
requireText(support, '/api/billing/pix', 'HML panel billing integration');
...
forbidText(hmlCommerce, 'x-tenant-id', 'HML commerce gateway');
...
forbidText(signup, 'eval(', 'Signup UI');
forbidText(hmlCommerce, 'APP_USR-', 'HML commerce gateway');
forbidText(hmlCommerce, 're_', 'HML commerce gateway');
